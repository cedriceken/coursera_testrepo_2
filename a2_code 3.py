# -*- coding: utf-8 -*-
"""
Student Name: Naman Gera, Cedric Ngaheu Eken
Student email: naman77@my.yorku.ca, cedric04@my.yorku.ca
Course Code: EECS 4414
"""
...
# """Edges present in  dblp2006_core but not present in  dblp2005-core."""
...
print("\n")
print("PART B: Displaying pageRank and  Edge Betweeness Centrality")
print("\n")
print("gcc_dblp2005 PageRank:")
print("")
getpageRank(gcc_dblp2005)
print("\n")
print("gcc_dblp2005w PageRank:")
print("")
getpageRank(gcc_dblp2005w)
print("\n")
print("gcc_dblp2006 PageRank:")
print("")
...
print("\n")
print("gcc_dblp2005w Edge Betweeness Centrality::")
print("")
getBetweenness(gcc_dblp2005w)
print("\n")
print("gcc_dblp2006 Edge Betweeness Centrality::")
print("")
getBetweenness(gcc_dblp2006)
print("\n")
print("\n")
print("PART C: Link Prediction and Precision")
print("\n")
print("Cores:")
print("\n")
